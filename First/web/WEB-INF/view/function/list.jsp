...
function($, LOCAL) { $(document).ready(function() {
    ...
    $grid.jqGrid({
        ...
        multiselect: true,
        url: LOCAL.url("/function/records"),
        editurl: LOCAL.url("/function/recordEdit"),
        cellurl: LOCAL.url("/function/recordEdit"),
        height: 300,
        colNames:['id', 'CompanyID', 'FunctionId', 'Name', 'Description', 'IsActive', 'Created', 'CreatedBy', 'CreatedByName', 'Updated', 'UpdatedBy', 'UpdatedByName'],
        colModel:[
            {name:'id', index:'id', hidden: true },
            {name:'adCompanyId', index:'adCompanyId', width:80, editable: false, frozen: true },
            {name:'adFunctionId', index:'adFunctionId', hidden: true },
